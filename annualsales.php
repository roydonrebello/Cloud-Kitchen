...
$sql1="select sum(amount) as total from orders where orderStatus='4' and orderDate like '$year-01%' ";
$result1 =  mysqli_query($conn,$sql1);
$value1 = mysqli_fetch_assoc($result1);
$jan_sales = $value1['total']+0;

$sql2="select sum(amount) as total from orders where orderStatus='4' and orderDate like '$year-02%' ";
$result2 =  mysqli_query($conn,$sql2);
$value2 = mysqli_fetch_assoc($result2);
$feb_sales = $value2['total']+0;	

$sql3="select sum(amount) as total from orders where orderStatus='4' and orderDate like '$year-03%' ";
$result3 =  mysqli_query($conn,$sql3);
$value3 = mysqli_fetch_assoc($result3);
$mar_sales = $value3['total']+0;

$sql4="select sum(amount) as total from orders where orderStatus='4' and orderDate like '$year-04%' ";
$result4 =  mysqli_query($conn,$sql4);
$value4 = mysqli_fetch_assoc($result4);
$apr_sales = $value4['total']+0;

	
$sql5="select sum(amount) as total from orders where orderStatus='4' and orderDate like '$year-05%' ";
...
$sql6="select sum(amount) as total from orders where orderStatus='4' and orderDate like '$year-06%' ";
$result6 =  mysqli_query($conn,$sql6);
$value6 = mysqli_fetch_assoc($result6);
$jun_sales = $value6['total']+0;
	

$sql7="select sum(amount) as total from orders where orderStatus='4' and orderDate like '$year-07%' ";
$result7 =  mysqli_query($conn,$sql7);
$value7 = mysqli_fetch_assoc($result7);
$jul_sales = $value7['total']+0;
	
	
$sql8="select sum(amount) as total from orders where orderStatus='4' and orderDate like '$year-08%' ";
$result8 =  mysqli_query($conn,$sql8);
$value8 = mysqli_fetch_assoc($result8);
$aug_sales = $value8['total']+0;

	
$sql9="select sum(amount) as total from orders where orderStatus='4' and orderDate like '$year-09%' ";
$result9 =  mysqli_query($conn,$sql9);
$value9 = mysqli_fetch_assoc($result9);
$sep_sales = $value9['total']+0;


$sql10="select sum(amount) as total from orders where orderStatus='4' and orderDate like '$year-10%' ";
$result10 =  mysqli_query($conn,$sql10);
$value10 = mysqli_fetch_assoc($result10);
$oct_sales = $value10['total']+0;


$sql11="select sum(amount) as total from orders where orderStatus='4' and orderDate like '$year-11%' ";
...
$sql12="select sum(amount) as total from orders where orderStatus='4' and orderDate like '$year-12%' ";
