...
$mobile= $_POST['phone'];
    ...
    #### 2Factor API Setting
    $APIKey=' d666c67a-daaa-11ed-addf-0200cd936042';
     ...
     if ( $otpValue <> '') ### OTP value entered by user
    {
        ...
        $API_Response_json=json_decode(file_get_contents("https://2factor.in/API/V1/$APIKey/SMS/VERIFY3/$VerificationSessionId/$otpValue"),false);
